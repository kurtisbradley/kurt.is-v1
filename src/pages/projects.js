    ...
    render() {
        ...
        return (
            <Layout title="Projects">
                ...
                <SEO />
                <article>
                    <p>Here's <b><i>some</i></b> of my work.<br/> It's a mix of full time, contract, and open source projects.</p>
                    ...
                    <ProjectListing projectEdges={filteredPosts} />
                </article>
                <style jsx>{`
                    .category-container {
                        display: flex;
